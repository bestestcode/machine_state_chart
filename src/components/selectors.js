...
function mapStateToProps(state) {
  return {
    temperatureOn: state.toggles.temperature,
    pressureOn: state.toggles.pressure,
    vibrationOn: state.toggles.vibration,
    currentOn: state.toggles.current,
    ultrasoundOn: state.toggles.ultrasound,
  };
}
